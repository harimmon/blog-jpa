...
public class RegexTest {
    ...
    // 소문자 대문자 숫자 특수문자가 포함되어야 하고 최소 2자부터 20자 사이이어야 한다.
    @Test
    public void password_test() {
        String password = " Ab1@";  // 공백이 포함된 경우는 실패하도록

        // 정규식: 소문자, 대문자, 숫자, 특수문자 각 1개 이상 포함, 공백 없이 길이 2~20자
        String regex = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[\\W_])\\S{2,20}$";
